...
<body>
    <div id="notfound">
        <div class="notfound">
            ...
            <p>Sentimos los inconveniente, Su pagina se encuentra en mantenimiento o Se ha cumplido la fecha limite de su plan.
            </p>
            <p>Si se ha cumplido la fecha limite de su plan y desea renovarlo por favor inicie sesión con la cuenta de usuario con la que genero su aplicacion en el
                siguiente enlace:
            </p>
            <a href="{{ env('APP_URL') }}">Renovar?</a>
        </div>
    </div>
</body>
