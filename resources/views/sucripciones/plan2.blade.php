...
@section('content_header')
    <h1>Suscripciones por 12 meses</h1>
@stop
...
$item->title = 'Suscripcion_12Meses';
$item->quantity = 1;
$item->unit_price = 2000;//$117.285 para cobrar 100.000
...
<div class="container w-75 shadow">
    <div class="row">
      <div class="col-sm">
        <h3 class="card-title">Suscripcion a nuestro plan por 12 Meses, realiza el pago seguro con:</h3><br>
